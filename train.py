...
mlp_model.save("digit_mlp_classifier.h5")
loaded_model = tf.keras.models.load_model("digit_mlp_classifier.h5")
loss_loaded, accuracy_loaded = loaded_model.evaluate(x_test_norm, y_test, verbose=0)
